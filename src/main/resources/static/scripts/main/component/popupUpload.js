...
'<div class="form-group"><label class="col-sm-2 control-label">内容</label><div class="col-sm-10"><textarea class="js-link form-control" rows="8" style="resize: none"></textarea></div></div>',
'<div class="form-group">',
